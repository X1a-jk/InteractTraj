...
if __name__ == "__main__":
    ...
    init_time = time.time()
    cfg_file = './srcs/configs/inference.yaml'
    cfg, model = load_model(cfg_file)
    map_data_file = "/home/ubuntu/xiajunkai/InteractTraj/srcs/utils/map.npy"
    map_vecs, map_ids = load_all_map_vectors(map_data_file)

    llm_cfg = get_config('./srcs/gpt/new.yaml')
    ...
    query = "Generate a scenario with two vehicles."
    print(f"{query=}")
